...
public class DiscapacitadoEspacio implements EspacioBase {
    private int id;
    private int numero;
    private int sedeId;
    private EstadoEspacio estado = EstadoEspacio.DISPONIBLE;
    private TipoEspacio tipo = TipoEspacio.DISCAPACITADO;

    public DiscapacitadoEspacio(int id, int numero, int sedeId) {
        this.id = id;
        this.numero = numero;
        this.sedeId = sedeId;
    }
    ...
    @Override
    public TipoEspacio getTipo() { return TipoEspacio.DISCAPACITADO; }
